...
## Corpus Check
- 104 files · ~43,869 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 723 nodes · 1076 edges · 50 communities (47 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95792434`
...
Cohesion: 0.05
Nodes (39): App(), AuthenticatedLayout(), Home(), RecipeEditPage(), ROUTE_TITLES, routeTitle(), ShoppingListEditPage(), { baseElement } (+31 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (34): asyncHandler(), createRecipesRouter(), INVALID_ID, NAME_REQUIRED, NOT_FOUND, parseId(), app, axiosError (+26 more)
...
Cohesion: 0.1
Nodes (17): requireAuth(), next, req, res, IngredientRepository, pool, repo, createIngredientsRouter() (+9 more)
...
Cohesion: 0.29
Nodes (5): SettingsPage(), ShoppingListSummary, mockedAxios, Theme, THEMES
...
## Knowledge Gaps
- **265 isolated node(s):** `IngredientGroup`, `mockedAxios`, `RECIPE_JSON_LD`, `json`, `graphJson` (+260 more)
...
- **What connects `IngredientGroup`, `mockedAxios`, `RECIPE_JSON_LD` to the rest of the system?**
