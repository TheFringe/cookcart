...
## Corpus Check
- 104 files · ~43,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 724 nodes · 1065 edges · 49 communities (46 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d63f838`
...
Cohesion: 0.11
Nodes (26): AddToListPanel(), Props, ShoppingListSummary, mockedAxios, onClose, recipe, groupIngredientsBySection(), groupStepsBySection() (+18 more)
...
Cohesion: 0.18
Nodes (14): IngredientDraft, ParsedRecipe, parseIngredientLine(), parseTextRecipe(), result, EMPTY_INGREDIENT, IngredientDraft, RecipeForm() (+6 more)
...
## Knowledge Gaps
- **269 isolated node(s):** `newListLink`, `nav`, `testIds`, `mockNavigate`, `ShoppingListSummary` (+264 more)
...
- **What connects `newListLink`, `nav`, `testIds` to the rest of the system?**
