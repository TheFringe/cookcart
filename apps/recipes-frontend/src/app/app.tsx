...
import { Route, Routes, useParams, Navigate, useLocation, useNavigate, NavLink } from 'react-router-dom';
    ...
    <ProtectedRoute>
      ...
      <header data-testid="app-header" className="app-header">
        ...
        <div className="app-header__right">
          ...
          <NavLink to="/settings" aria-label="Inställningar" className="app-header__settings-link">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <button onClick={logout} aria-label="Logga ut" className="app-header__logout">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
